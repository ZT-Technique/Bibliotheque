...
<div class="max-w-3xl mx-auto">
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-2xl font-bold text-inoha-black">Ajouter un Administrateur</h1>
            <p class="text-sm text-gray-500 mt-1">Créez un nouvel accès à l'espace de gestion</p>
        </div>
    ...
    <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="p-8 space-y-8">
                ...
                <div class="flex flex-col md:flex-row items-center gap-8 pb-4">
                    ...
                    <div class="flex-1 text-center md:text-left">
                        ...
                        <p class="text-gray-500 text-sm">PNG, JPG ou GIF. Max 2Mo.</p>
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" required maxlength="255" placeholder="Nom de l'utilisateur"
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email') }}" required maxlength="255" placeholder="email@exemple.com"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="password" class="block text-sm font-bold text-gray-700 mb-2">Mot de passe <span class="text-rose-500">*</span></label>
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-sm font-bold text-gray-700 mb-2">Confirmer le mot de passe <span class="text-rose-500">*</span></label>
                ...
                <div class="pt-4 border-t border-gray-100">
                    <label class="relative inline-flex items-center cursor-pointer group">
                        <input type="checkbox" name="is_admin" value="1" {{ old('is_admin', '1') == '1' ? 'checked' : '' }} class="sr-only peer">
                        ...
                        <span class="ms-4 text-sm font-bold text-gray-700 group-hover:text-inoha-black transition-colors">Définir comme Administrateur</span>
                    </label>
                    <p class="mt-2 text-xs text-gray-400 italic">Un administrateur a un accès complet à la gestion du catalogue et des utilisateurs.</p>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-4 pt-4">
            <button type="submit" id="submit-button" class="flex-1 flex items-center justify-center gap-3 px-8 py-5 bg-inoha-green text-white rounded-2xl font-bold hover:bg-inoha-green-dark transition-all shadow-xl shadow-inoha-green/30 text-lg disabled:opacity-70 disabled:cursor-not-allowed">
                ...
                <span id="button-text">Créer le compte</span>
            </button>
...
<script>
    ...
    document.getElementById('submit-button').closest('form').addEventListener('submit', function(e) {
        ...
        text.innerText = 'Création en cours...';
    });
</script>
@endpush
@endsection
